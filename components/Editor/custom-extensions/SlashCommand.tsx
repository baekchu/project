...
import {
  ...
  TooltipProvider,
  TooltipTrigger,
} from "@/components/ui/Editor-Tooltip";
...
const CommandList = ({
  ...
  return items.length > 0 ? (
    <div
      ...
      className="file:z-50 h-auto max-h-[330px] w-72 scroll-smooth rounded-md border-0 bg-white shadow-md transition-all overflow-hidden"
    >
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    className={cn(
                      `flex w-full items-center space-x-2 rounded-md px-2 py-1 text-left text-sm text-primary hover:bg-[#f8edf976] outline-none`,
                ...
                <TooltipContent
                  side="right"
                  className="bg-SecondaryColor h-auto flex flex-col max-w-[160px] p-2"
                >
                  <Image
                    src={item.tooltipSrc}
                    alt="text"
